...
# For example: Load the dataset (assume CSV with features + label in last column)
data = pd.read_csv("marriage_data_india.csv")  # Replace with actual path
# Show first 5 rows
data.head()
# Inspect dataset details (columns, data types, missing values)
data.info()
...
# Show the first few rows of the new encoded dataset
...
# ==========================
torch.save(model.state_dict(), "divorce_predictor_model_01.pth")
print("✅ Model saved to divorce_predictor_model.pth")
